...
- 🐞 [PR](https://github.com/ZLMediaKit/ZLMediaKit/pull/4582) [![pending](https://img.shields.io/badge/status-pending-yellow)](https://github.com/ZLMediaKit/ZLMediaKit/pull/4582) to [ZLMediaKit](https://github.com/ZLMediaKit/ZLMediaKit): 修复 RTSP 取流过程中由于 updateRtcpContext 对空 RtpPacket 解引用而导致的 SIGSEGV 崩溃问题，提高在嵌入式环境下的稳定性。
